...
class AppColors {
  ...
  static const List<BoxShadow> shadowSoft = [
    BoxShadow(color: Color(0x0A282A31), offset: Offset(0, 1), blurRadius: 2),
    BoxShadow(color: Color(0x08282A31), offset: Offset(0, 1), blurRadius: 1),
  ];

  static const List<BoxShadow> shadowCard = [
    BoxShadow(color: Color(0x1F282A31), offset: Offset(0, 6), blurRadius: 24, spreadRadius: -8),
    BoxShadow(color: Color(0x0F282A31), offset: Offset(0, 2), blurRadius: 6, spreadRadius: -2),
  ];

  static const List<BoxShadow> shadowFloat = [
    BoxShadow(color: Color(0x40282A31), offset: Offset(0, 20), blurRadius: 50, spreadRadius: -20),
  ];
}
